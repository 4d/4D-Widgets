...
If (Is Windows:C1573)  //----------- WIN -----------
	...
	OBJECT GET COORDINATES:C663(*;"BgndLeft_Win";$x1;$y1;$x2;$y2)
	$MemoX1:=$x1
	$MemoY1:=$y1
	OBJECT GET COORDINATES:C663(*;"BgndRight_Win";$x1;$y1;$x2;$y2)
	$MemoX2:=$x2
	$MemoY2:=$y2
...
Else   //---------------  MAC ------------------
	...
	OBJECT GET COORDINATES:C663(*;"SearchButton_Mac";$x1;$y1;$x2;$y2)
	OBJECT MOVE:C664(*;"SearchButton_Mac";$x1;$y1;$x1+$Width;$y2;*)
	OBJECT SET FORMAT:C236(*;"SearchButton_Mac";$Format)
