...
* create an object that calls the [DatePicker Display Dialog](Methods/Methods/DatePicker%20Display%20Dialog.pt.md) component method. This method returns the date selected by the user.
